  ...
  <div className="bg-white p-8 rounded-lg shadow-md">
    ...
    <div className="prose lg:prose-lg max-w-none text-gray-700 space-y-4">
      ...
      <ul className="list-disc pl-5 space-y-2">
        <li>
          <strong>Jednostavnost:</strong> Intuitivan interfejs koji vam ne stoji
          na putu.
        </li>
        <li>
          <strong>Zajednica:</strong> Povežite se sa drugim autorima i čitaocima
          kroz praćenje, komentare i diskusije.
        </li>
        <li>
        ...
        <li>
          <strong>Performanse:</strong> Brza i responzivna platforma dostupna na
          svim uređajima.
        </li>
      </ul>
      <p className="mt-6">

  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 mb-6">
        Najnovije objave autora koje pratite.
      </p>

      {error && <p className="text-red-500 text-center bg-red-100 p-4 rounded-md">{error}</p>}
      ...
      {!error && (
        <InfiniteScroll
          ...
          next={fetchMorePosts}
          hasMore={hasMore}
          loader={<h4 className="text-center text-gray-500 py-4">Učitavanje...</h4>}
          endMessage={
      ...
      {!initialLoad && posts.length === 0 && !error && (
        <div className="text-center py-10">
            <p className="text-gray-500">Nema novih objava od autora koje pratite.</p>
            <p className="text-gray-400 mt-2">Pokušajte zapratiti još autora kako biste vidjeli njihov sadržaj.</p>
        </div>
      )}
    </div>
  );

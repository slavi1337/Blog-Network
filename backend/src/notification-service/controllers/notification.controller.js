...
exports.getAllNotifications = async (req, res) => {
  ...
  try {
    ...
    const { rows } = await pool.query(
          ...
          CASE
              WHEN n.type = 'new_post_from_followed' 
                  THEN (
                    ...
                    WHERE po.id = n.related_entity_id
                  )
              ...
              WHEN n.type = 'reply_to_comment' 
                  THEN (
                    ...
                    WHERE co.parent_comment_id = n.secondary_entity_id
      ...
      LEFT JOIN posts p
          ON n.related_entity_id = p.id
          AND n.type IN ('new_post_from_followed', 'reply_to_comment')

      LEFT JOIN reported_issues ri
          ON n.related_entity_id = ri.id
          AND n.type = 'issue_status_change'
